...
(defun color-theme-the-matrix ()
  "Color theme by akiritsu@outlook.com"
  (interactive)
  (color-theme-install
   '(color-theme-matrix
     ((background-color . "black")
      (background-mode . dark)
      (background-toolbar-color . "grey")
      (border-color . "black")
      (bottom-toolbar-shadow-color . "grey80")
      (cursor-color . "yellow")
      (foreground-color . "#30bb38")
      (mouse-color . "#30bb38")
      (top-toolbar-shadow-color . "grey55"))
     ...
     (default ((t (:stipple nil :background "black" :foreground
                            "#30bb38" :inverse-video nil :box nil :strike-through nil :overline nil
     ...
     (border ((t (:background "grey90")))) ; colors' here
     (border-glyph ((t (nil))))
     (buffers-tab ((t (nil))))
     (button ((t (nil))))
     ...
     (custom-changed-face ((t (:background "blue" :foreground "gray90"))))
     ...
     (custom-set-face ((t (:background "gray90" :foreground "blue"))))
     ...
     (font-lock-builtin-face ((t (:foreground "#4F8EA0")))) ; :tags
     (font-lock-comment-face ((t (:foreground "#AE999E")))) ; comments in codes
     (font-lock-constant-face ((t (:foreground "Aquamarine"))))
     (font-lock-doc-face ((t (nil))))
     (font-lock-doc-string-face ((t (:foreground "#9F3010")))) ; strings in codes
     (font-lock-exit-face ((t (nil))))
     (font-lock-function-name-face ((t (:bold t :foreground "#912CAE")))) ; function names in codes
     (font-lock-keyword-face ((t (:foreground "Cyan"))))  ; keywords
     (font-lock-other-emphasized-face ((t (nil))))
     (font-lock-other-type-face ((t (nil))))
     (font-lock-preprocessor-face ((t (:foreground "Aquamarine"))))
     (font-lock-reference-face ((t (:foreground "violet"))))
     (font-lock-special-comment-face ((t (nil))))
     (font-lock-special-keyword-face ((t (nil))))
     (font-lock-string-face ((t (:foreground "orange"))))
     (font-lock-type-face ((t (:foreground "PaleGreen"))))
     (font-lock-variable-name-face ((t (:foreground "LightGoldenrod"))))
     (font-lock-warning-face ((t (:bold t :foreground "Pink")))) ;warning strings
     (fringe ((t (nil))))
     ...
     (gnus-header-content-face ((t (:italic t :foreground "gray60"))))
...
;;; Modeline settings
     (mode-line ((t (:bold t :background "#111111" :foreground "#606060" :weight bold))))
     (mode-line-inactive ((t (:background "#100515" :foreground "#444444"))))
     (modeline-buffer-id ((t (:background "#282828" :foreground "#307520"))))
     (modeline-mousable ((t (:background "grey" :foreground "black"))))
     (modeline-mousable-minor-mode ((t (:background "grey" :foreground "black"))))
     (mouse ((t (nil))))
     ...
     (scroll-bar ((t (nil))))
     (secondary-selection ((t (:background "darkgreen" :foreground
                                           "black"))))
     ...
     (widget-inactive-face ((t (:foreground "gray50"))))
